package org.yuntao.framework.tool.ipseeker;
...
public class IPSeeker {
	...
	private IPSeeker() {
		...
		try {
			...
			throw new IllegalStateException("请把qqwry.dat放在classpath根目录下",e);
		}
		// 如果打开文件成功，读取文件头信息
		if (ipFile != null) {
			try {
	...
	public static void main(String args[]) {
		System.out.println(IPSeeker.getInstance().getAddress("202.96.0.20"));
	}
